...
-(IBAction)registerMasternode:(id)sender {
    ...
    NSString * payoutAddress = [self.payToAddressTableViewCell.valueTextField.text isValidAxeAddressOnChain:self.chain]?self.payToAddressTableViewCell.textLabel.text:self.account.receiveAddress;
