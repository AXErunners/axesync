...
-(UILabel*)titleLabel {
    ...
    NSMutableAttributedString * attributedAxeString = [[manager attributedStringForAxeAmount:self.chainManager.chain.balance withTintColor:[UIColor whiteColor]] mutableCopy];
    NSString * titleString = [NSString stringWithFormat:@" (%@)",
                              [manager localCurrencyStringForAxeAmount:self.chainManager.chain.balance]];
