...
@interface DSContactSendAxeViewController ()
...
@implementation DSContactSendAxeViewController
...
- (IBAction)sendTransaction:(id)sender {
    ...
    paymentRequest.amount = [[DSPriceManager sharedInstance] amountForAxeString:self.amountTextField.text];
