//
//  DSAccountChooserViewController.m
//  AxeSync_Example
//
...
@interface DSAccountChooserViewController ()
@property (strong, nonatomic) IBOutlet UIBarButtonItem *chooseButton;
- (IBAction)choose:(id)sender;

@end

@implementation DSAccountChooserViewController
...
-(void)configureCell:(DSAccountTableViewCell*)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.balanceLabel.text = [[DSPriceManager sharedInstance] stringForAxeAmount:account.balance];
    [[DSPriceManager sharedInstance] stringForAxeAmount:account.balance];
}
