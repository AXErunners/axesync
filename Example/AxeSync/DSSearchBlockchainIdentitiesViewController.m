...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.usernameLabel.text = identity.currentAxepayUsername;
...
-(void)searchByNamePrefix:(NSString*)namePrefix {
    [self.chainManager.identitiesManager searchIdentitiesByAxepayUsernamePrefix:namePrefix withCompletion:^(BOOL succeess, NSArray<DSBlockchainIdentity *> * _Nullable blockchainIdentities, NSArray<NSError *> * _Nonnull errors) {
        if (succeess) {
