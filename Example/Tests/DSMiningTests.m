...
- (void)setUp {
    self.chain = [DSChain setUpDevnetWithIdentifier:@"miningTest" withCheckpoints:nil withMinimumDifficultyBlocks:0 withDefaultPort:3000 withDefaultDapiJRPCPort:3000 withDefaultDapiGRPCPort:3010 dpnsContractID:UINT256_ZERO axepayContractID:UINT256_ZERO isTransient:YES];
