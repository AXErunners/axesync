...
{
    XCTAssertFalse([@"7s18Ypj1scza76SPf56Jm9zraxSrv58TgzmxwuDXoauvV84ud61" isValidAxePrivateKeyOnChain:self.chain],
                   @"[NSString+Base58 isValidAxePrivateKey]");
    
    // uncompressed private key
    XCTAssertTrue([@"7r17Ypj1scza76SPf56Jm9zraxSrv58ThzmxwuDXoauvV84ud62" isValidAxePrivateKeyOnChain:self.chain],
                  @"[NSString+Base58 isValidAxePrivateKey]");
...
-(void)testBLSSign {
    ...
    //In axe we use SHA256_2, however these test vectors from the BLS library use a single SHA256
