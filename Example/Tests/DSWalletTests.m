...
//TODO: port all applicable tests from axej and axecore
...
- (void)testWalletManager
{
    ...
    XCTAssertEqual([manager amountForAxeString:nil], 0, @"[DSPriceManager amountForAxeString:]");
    
    XCTAssertEqual([manager amountForAxeString:@""], 0, @"[DSPriceManager amountForAxeString:]");
    
    s = [manager stringForAxeAmount:0];
    XCTAssertEqual([manager amountForAxeString:s], 0, @"[DSPriceManager amountForAxeString:]");
    
    s = [manager stringForAxeAmount:100000000];
    XCTAssertEqual([manager amountForAxeString:s], 100000000, @"[DSPriceManager amountForAxeString:]");
    
    s = [manager stringForAxeAmount:1];
    XCTAssertEqual([manager amountForAxeString:s], 1, @"[DSPriceManager amountForAxeString:]");
    
    s = [manager stringForAxeAmount:2100000000000000];
    XCTAssertEqual([manager amountForAxeString:s], 2100000000000000, @"[DSPriceManager amountForAxeString:]");
    
    s = [manager stringForAxeAmount:2099999999999999];
    XCTAssertEqual([manager amountForAxeString:s], 2099999999999999, @"[DSPriceManager amountForAxeString:]");
    
    s = [manager stringForAxeAmount:2099999999999995];
    XCTAssertEqual([manager amountForAxeString:s], 2099999999999995, @"[DSPriceManager amountForAxeString:]");
    
    s = [manager stringForAxeAmount:2099999999999990];
    XCTAssertEqual([manager amountForAxeString:s], 2099999999999990, @"[DSPriceManager amountForAxeString:]");
}
