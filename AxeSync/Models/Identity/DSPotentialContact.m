...
-(instancetype)initWithAxepayUser:(DSAxepayUserEntity*)axepayUserEntity {
    DSBlockchainIdentityUsernameEntity * usernameEntity = [axepayUserEntity.associatedBlockchainIdentity.usernames anyObject];
    self = [self initWithUsername:usernameEntity.stringValue avatarPath:axepayUserEntity.avatarPath publicMessage:axepayUserEntity.publicMessage];
    if (self) {
        _associatedBlockchainIdentityUniqueId = axepayUserEntity.associatedBlockchainIdentity.uniqueID.UInt256;
    }
    return self;
}
