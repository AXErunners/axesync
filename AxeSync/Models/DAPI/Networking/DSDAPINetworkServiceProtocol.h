...
/**
 Get the total amount of haks received by an addresses
...
/**
 Get the total amount of haks sent by an addresses
...
- (id<DSDAPINetworkServiceRequest>)getAxepayIncomingContactRequestsForUserId:(NSData*)userId
                                             since:(NSTimeInterval)timestamp
                                           success:(void (^)(NSArray<NSDictionary *> *documents))success
                                           failure:(void (^)(NSError *error))failure;

- (id<DSDAPINetworkServiceRequest>)getAxepayOutgoingContactRequestsForUserId:(NSString*)userId
                                             since:(NSTimeInterval)timestamp
                                           success:(void (^)(NSArray<NSDictionary *> *documents))success
                                           failure:(void (^)(NSError *error))failure;
