...
@property (nullable, nonatomic, retain) NSData * axepaySyncronizationBlockHash;
...
@property (nullable, nonatomic, retain) DSAxepayUserEntity *matchingAxepayUser;
@property (nullable, nonatomic, retain) NSSet<DSBlockchainIdentityUsernameEntity *> *usernames;
@property (nullable, nonatomic, retain) DSChainEntity *chain;
@property (nullable, nonatomic, retain) DSBlockchainIdentityUsernameEntity * axepayUsername;
