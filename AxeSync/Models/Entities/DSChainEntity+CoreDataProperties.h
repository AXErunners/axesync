...
@property (nullable, nonatomic, retain) NSSet<DSAxepayUserEntity *> *contacts;
...
- (void)addContactsObject:(DSAxepayUserEntity *)value;
- (void)removeContactsObject:(DSAxepayUserEntity *)value;
- (void)addContacts:(NSSet<DSAxepayUserEntity *> *)values;
- (void)removeContacts:(NSSet<DSAxepayUserEntity *> *)values;
