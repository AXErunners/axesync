...
-(NSString*)debugDescription {
    return [NSString stringWithFormat:@"%@ - { %@ -> %@ / %d }",[super debugDescription],self.sourceContact.associatedBlockchainIdentity.axepayUsername.stringValue,self.destinationContact.associatedBlockchainIdentity.axepayUsername.stringValue,self.account.index];
}
