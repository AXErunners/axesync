...
#define INSIGHT_URL          @"https://insight.axe.org/insight-api-axe"
#define INSIGHT_FAILOVER_URL @"https://insight.axe.show/api"

#define TESTNET_INSIGHT_URL @"https://testnet-insight.axerunners.org/insight-api-axe"
...
// queries insight.axe.org and calls the completion block with unspent outputs for the given addresses
    ...
    [[[NSURLSession sharedSession] dataTaskWithRequest:req
                                     completionHandler:^(NSData *data, NSURLResponse *response, NSError *error) {
                                         ...
                                         if (error) {
                                             ...
                                             completion(nil,
                                                        [NSError errorWithDomain:@"AxeSync" code:417 userInfo:@{NSLocalizedDescriptionKey:
