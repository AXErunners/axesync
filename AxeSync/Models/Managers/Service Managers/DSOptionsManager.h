...
typedef NS_ENUM(NSUInteger, DSSyncType) {
    ...
    DSSyncType_DPNS = 1 << 8,
    DSSyncType_Axepay = 1 << 9,
    DSSyncType_Default = DSSyncType_SPV | DSSyncType_Mempools | DSSyncType_VerifiedMasternodeList | DSSyncType_Sporks | DSSyncType_BlockchainIdentities | DSSyncType_DPNS | DSSyncType_Axepay,
