...
@interface DSParseAxeCentralResponseOperation ()

@property (strong, nonatomic, nullable) NSNumber *btcAxePrice;

@end

@implementation DSParseAxeCentralResponseOperation
...
- (void)execute {
    ...
    NSNumber *btcAxePrice = self.responseToParse[@"exchange_rates"][@"btc_axe"];
