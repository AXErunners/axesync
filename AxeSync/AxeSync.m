...
/*
 ...
 e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateLaunchForTaskWithIdentifier:@"org.axecore.axesync.backgroundblocksync"]

 e -l objc -- (void)[[BGTaskScheduler sharedScheduler] _simulateExpirationForTaskWithIdentifier:@"org.axecore.axesync.backgroundblocksync"]
 */

static NSString * const BG_TASK_REFRESH_IDENTIFIER = @"org.axecore.axesync.backgroundblocksync";
...
{
    static AxeSync *_sharedInstance = nil;
...
-(void)wipeBlockchainDataForChain:(DSChain*)chain inContext:(NSManagedObjectContext*)context {
    ...
    [context performBlockAndWait:^{
        ...
        [DSAxepayUserEntity deleteContactsOnChainEntity:chainEntity];// this must move after wipeBlockchainInfo where blockchain identities are removed
        [context ds_save];
